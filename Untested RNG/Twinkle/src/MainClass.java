...
public class MainClass {
    static JMenuBar mb;
    static JMenu m,m1;
    static JMenuItem c, o, sv, q, genr, sk;
    ...
    public static void gen_values_for_lock() {
    	cl();
		disp_rec("String spart = \"");
        StringBuilder str = new StringBuilder();
		SecureRandom sp1 = new SecureRandom();
		int n = 35 + sp1.nextInt(40);
		int m = 0;
		int m1 = 0;
		for (int i = 0; i < n; i++) {
			m = sp1.nextInt(3);
			if (m == 0)
				str.append((char)(65 + (sp1.nextInt(26))));
			if (m == 1)
				str.append((char)(97 + (sp1.nextInt(26))));
			if (m == 2)
				str.append((char)(48 + (sp1.nextInt(10))));
		}
		disp_rec(str.toString() + "\";\n");
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        genr = new JMenuItem("Generate unique values for the lock");
